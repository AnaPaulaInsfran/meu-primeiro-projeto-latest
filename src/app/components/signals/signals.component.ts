...
export class SignalsComponent {
  public firstName =signal('Ana');
  public lastName = signal('Insfran');
  ...
  mas podem ser úteis em circuntãncias específicas.
  ...
  - Adicionano comportamento DOM personalizado que não pode ser expresso com
  sintaxe de modelo.

  - Executar renderizção personalizada em um <canvas>, biblioteca de gráficos
 ...
 public updateName(){
   return this.firstName.set('Paula')
 }
